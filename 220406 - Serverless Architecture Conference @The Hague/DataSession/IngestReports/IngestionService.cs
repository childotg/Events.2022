...
namespace IngestReports
{
    ...
    {
        private string _executionEnvironment = "<env>";
        private string _storageConnection = "[storage]";
        ...
        internal void Run()
        {
            ...
            foreach (var item in reports)
            {
                ...
                //Step 1 - anonymous batches
                FileStorage(container, conversions, clicks, impressions);
        ...
        private void FileStorage(BlobContainerClient container, ConversionEvent[]? conversions, ClickEvent[]? clicks, ImpressionEvent[]? impressions)
        {
